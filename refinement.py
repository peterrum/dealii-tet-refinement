...
def main():
    ...
    if c == 0:
      subline_definitions_vertics = subline_definitions_vertics + [[6,8]] 
    if c == 1:
      subline_definitions_vertics = subline_definitions_vertics + [[5,7]] 
    if c == 2:
      subline_definitions_vertics = subline_definitions_vertics + [[4,9]] 
    ...
    if c == 1:
      subface_definitions_vertics = subface_definitions_vertics + [[5,4,7],[6,5,7],[8,7,5],[7,9,5]]
    if c == 2:
      subface_definitions_vertics = subface_definitions_vertics + [[5,4,9],[4,6,9],[7,4,9],[4,8,9]]
    ...
    if c == 1:
      subcell_definititions_vertices = subcell_definititions_vertices + [[4,5,6,7], [4,7,8,5], [6,9,7,5], [5,8,9,7]]
    if c == 2:
      subcell_definititions_vertices = subcell_definititions_vertices + [[4,5,6,9], [4,7,8,9], [6,9,7,4], [5,8,9,4]]
